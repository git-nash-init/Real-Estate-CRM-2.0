-- Safe & Idempotent Schema Migration for Channel Partner Module (EstateCRM)
...
ALTER TABLE public.channel_partners ADD COLUMN IF NOT EXISTS partner_code TEXT UNIQUE;
...
ALTER TABLE public.channel_partners ADD COLUMN IF NOT EXISTS rera_number TEXT;
